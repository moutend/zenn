...
さて、AWSの知識地図の第3章（3.1.6 IAMロール）にて次のような説明がされています。以下、本文から引用します。
...
- AdministratorAccess権限を持つIAMユーザーは作成済みとします。IAMユーザーの作成方法については書籍の第2章を参照してください。
...
2. [aws-cliでAssumeRoleを実行してみる sts assume-roleコマンドパターン・config+credentialsパターン - Qiita](https://qiita.com/SAITO_Keita/items/b29e1eb4792bab2d5f57)
